...
class LikedArticlesView extends ConsumerStatefulWidget {
  const LikedArticlesView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _LikedArticlesViewState();
}

class _LikedArticlesViewState extends ConsumerState<LikedArticlesView> {
        ...
        appBar: AppBar(
          ...
          bottom: AppBar(
            ...
            title: TabBar(
              ...
              enableFeedback: true,
              tabs:
                  newsInterests.map((interest) => Tab(text: interest)).toList(),
            ),
          ),
        ),
        body: Container(
                              ...
                              onTap: () {
                                context.pushNamed(
                                    ...
                                    pathParameters: {
                                      ...
                                      "heroTag":
                                          'likedArticlesScreentagImage$index',
                                      "articleTitle":
