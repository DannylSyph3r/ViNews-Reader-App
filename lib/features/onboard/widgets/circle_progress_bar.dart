...
class CircleProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final shortestSide =
        mathematics.min(constrainedSize.width, constrainedSize.height);
    ...
    const double startAngle = -(2 * mathematics.pi * 0.25);
    final double sweepAngle = (2 * mathematics.pi * (percentage));
