...
class BookmarkSearchResultsView extends ConsumerStatefulWidget {
  final String searchedWord;
  const BookmarkSearchResultsView({super.key, required this.searchedWord});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _BookmarkSearchResultsViewState();
}

class _BookmarkSearchResultsViewState
    extends ConsumerState<BookmarkSearchResultsView> {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            ...
            children: [
              PhosphorIcons.regular.magnifyingGlass.iconslide(size: 19.sp),
              7.sbW,
              "Search results for".txtStyled(fontSize: 18.sp),
              3.sbW,
              Container(
                      ...
                      onTap: () {
                        context.pushNamed(
                            ...
                            pathParameters: {
                              ...
                              "heroTag":
                                  'bookmarkedArticlesSearchScreentagImage$index',
